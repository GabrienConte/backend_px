...
INSERT INTO usuario (nome, login, senha, permissao, descricao, facebook, instagram, linkedin, github) VALUES
...
INSERT INTO projeto (nome, descricao, link, dataPublicacao, resumo, idUsuario) VALUES
    ('Projeto A', 'Descrição do Projeto A', 'https://projetoa.com', '2023-01-15', 'Resumo do Projeto A', 1),
    ('Projeto B', 'Descrição do Projeto B', 'https://projetob.com', '2023-02-20', 'Resumo do Projeto B', 2),
    ('Projeto C', 'Descrição do Projeto C', 'https://projetoc.com', '2023-03-25', 'Resumo do Projeto C', 3);
