...
public class MinhaRedeController {
    ...
    public MinhaRedeController(ProjetoService service, UsuarioService serviceUsuario, RedeService serviceRede) {
    ...
    public List<Projeto> index() {
        return this.service.obterProjetosDosSeguidores(1L);
    }
